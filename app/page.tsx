      ...
      >
        ...
        <div className="hero-content relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
          <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h1
              id="hero-title"
              className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-8 leading-[0.9] tracking-tight drop-shadow-[0_35px_70px_rgba(147,51,234,1)]"
            >
              A NEW BREED OF<br />
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-12 max-w-4xl leading-relaxed font-light drop-shadow-[0_20px_40px_rgba(147,51,234,0.9)]">
